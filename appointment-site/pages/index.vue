<template>
  <div class="home page-component">
    ...
    <div v-for="(item, index) in list" :key="index" class="v-card clickable list-item space"
    @click="show(item.hoscode)">
      <div class="">
        <div class="hospital-list-item hos-item" index="0">
          ...
          class="iconfont"></span>{{ item.param.hostypeString }}
          </div>
          <div class="icon-wrapper">
            <span class="iconfont"></span>{{ item.bookingRule.releaseTime }}放号
          </div>
      </div>
    </div>
