    ...
    <div class="header-container">
        ...
        <!-- logo -->
            <div class="left-wrapper v-link selected">
                ...
                <span class="text" @click="returnindex()">易医 预约挂号统一平台</span>
            </div>
        <!-- 搜索框 -->
        ...
        <div class="right-wrapper">
          ...
          <el-dropdown v-if="name != ''" @command="loginMenu">
            ...
            <el-dropdown-menu class="user-name-wrapper" slot="dropdown">
              ...
              <el-dropdown-item command="/logout" @click="loginout()" divided>退出登录</el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </div>
        </div>
  ...
  methods: {
    ...
    loginCallback(name, token, openid) {
      // 打开手机登录层，绑定手机号，改逻辑与手机登录一致
       ...
       // this.res = JSON.stringify(openid)

        if (JSON.stringify(openid) != 'null') {
          this.res = "第一次登录，请使用手机进行绑定"
